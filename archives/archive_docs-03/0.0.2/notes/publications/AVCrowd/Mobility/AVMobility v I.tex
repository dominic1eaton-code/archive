...
\subsection{The Cognition Challenge}




\subsection{The Communications Challenge}
...
\subsection{The Security Challenge}




\subsection{The Economics Challenge}



\subsection{The Organization Challenge}
...
\item creation of optimal vehicle platooning strategies for formation of physical layer for a vehicle edge network 
\end{itemize}
...
\subsection{Platooning Characteristics}

\subsubsection{Formation Control}

\subsubsection{Node Dynamics}
...
\subsubsection{Distributed Controller}




\subsection{Platoon Metrics}

\subsubsection{String Stability}

\subsubsection{String Margin}

\subsubsection{String Coherence Bounds}





\subsection{Platoon Method Characteristics}

\subsubsection{Formation Control}

\paragraph{Leader-Follower Approach}


\paragraph{Virtual Structure Approach}


\paragraph{Behavior Based Approach}
...
Currently: Distance gap based 

Then: headway timing based 

Eventually: Non-Linear Distance
...
\subsection{Distributed Controller Process Properties}
...
\subsubsection{Type of control}

regulation / economic control goal



\subsubsection{Coupling Source}

points of non separation in the Control Problem - 
TBD ...
...
\subsection{Distributed Controller Architecture Properties}
...
\subsubsection{Controller Knowledge}

Strictly Local 


\subsubsection{Computation Type}

Iterative Computational model 


\subsubsection{Controller attitude}
...
Parallel Communication Model / Structure
...
\subsubsection{Optimization Variables (Type)}

Real Numbers


- perhaps Integers for platoon representation  
...
\subsection{Platoon Method Properties}

\subsubsection{Optimality}

\subsubsection{Sub-Optimality Bounds } 
...
\subsection{Platoon Characteristic}
...
**Measurements of position/velocity/etc... assume origin of measurements at mass center of vehicle
...
\section{Vehicle Dynamics Modeling}
...
\section{Platooning Controls Algorithm}




\subsection{Platoon Negotiations}
...
\paragraph{Non Cooperation}





\section{Platooning Controls Architecture}
...
\section{Simulation and Testbed}
