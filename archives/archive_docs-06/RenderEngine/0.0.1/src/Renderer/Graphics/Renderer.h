...
namespace RenderEngine
{
    ...
    private:
        /* Perform main render loop
          Each frame should have its own command buffer, set of semaphores, 
          and fence. Rename and then change them to be std::vectors of the objects:  */
        void drawFrame();
