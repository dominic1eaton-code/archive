    ...
    * color is either a color code (of any kind) or a 2d array. This is
        ...
        def rk45(x0, y0, f):
            ...
            while check(xi, yi):
                ...
                try:
                    ...
                    k5x, k5y = f(
                        xi + 439. / 216 * ds * k1x - 8 * ds * k2x + 3680. / 513 * ds * k3x - 845. / 4104 * ds * k4x,
                        yi + 439. / 216 * ds * k1y - 8 * ds * k2y + 3680. / 513 * ds * k3y - 845. / 4104 * ds * k4y)
                    k6x, k6y = f(
                        xi - 8. / 27 * ds * k1x + 2 * ds * k2x - 3544. / 2565 * ds * k3x + 1859. / 4104 * ds * k4x - 11. / 40 * ds * k5x,
                ...
                dx5 = ds * (
                            16. / 135 * k1x + 6656. / 12825 * k3x + 28561. / 56430 * k4x - 9. / 50 * k5x + 2. / 55 * k6x)
                dy5 = ds * (
                            16. / 135 * k1y + 6656. / 12825 * k3y + 28561. / 56430 * k4y - 9. / 50 * k5y + 2. / 55 * k6y)
    ...
    for t in trajectories:
        ...
        if type(linewidth) == numpy.ndarray:
            ...
            arrowlinewidth = args['linewidth'][int(len(tgx) / 2)]
        else:
        ...
        if type(color) == numpy.ndarray:
            ...
            arrowcolor = args['color'][int(len(tgx) / 2)]
        else:
            args['color'] = color
            arrowcolor = color
