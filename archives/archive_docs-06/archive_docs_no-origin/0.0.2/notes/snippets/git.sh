...
git filter-branch --force --index-filter "git rm --cached --ignore-unmatch 0.0.2/notes/Presentations/AVSIM_presentation/FinalPresentation_AVSIM.pptx" --prune-empty --tag-name-filter cat -- --all
