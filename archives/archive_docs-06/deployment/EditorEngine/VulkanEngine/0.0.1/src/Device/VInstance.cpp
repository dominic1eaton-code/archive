...
bool VInstance::create(VkApplicationInfo appInfo)
{
...
bool VInstance::createInfo() const
{
    return m_createInfo;
}

VkApplicationInfo VInstance::appInfo() const
{
    return m_appInfo;
}

VkInstanceCreateInfo VInstance::extensions() const
{
    return m_extensions;
}

VkInstanceCreateInfo VInstance::layers() const
{
    return m_layers;
}
