...
macro(setup_build_environment)
    ...
    option(BUILD_VERBOSE "enable verbose cmake log messages" ON)
    # set(ENABLE_UNIT_TEST TRUE CACHE BOOL "")
    ...
    # set(PROJECT_INSTALLATION_PATH "${CMAKE_HOME_DIRECTORY}/${PROJECT_DEFAULT_INSTALLATION_PREFIX}" CACHE PATH "project install path")
    # set(PROJECT_INSTALLATION_PREFIX "${CMAKE_HOME_DIRECTORY}/${PROJECT_DEFAULT_INSTALLATION_PATH}" CACHE PATH "project install path")
