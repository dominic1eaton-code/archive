...
// {
//     std::string shaderLibraryPath = std::filesystem::path(std::filesystem::path(info.mount) / "/dev/projects/v0.0.1/ogunv2/ogun/assets/shaders").string();
...
//     // std::string testTextureImage = "D:/dev/projects/ogun/assets/textures/grass-texture-background.jpg";
//     uint32_t mipLevels;
...
//     const uint32_t MAX_FRAME_COUNT = 10000000000u;
