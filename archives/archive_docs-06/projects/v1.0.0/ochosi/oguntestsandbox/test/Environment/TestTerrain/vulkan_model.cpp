...
glm::vec2 VulkanModelSupport::createTextureImage(VkPhysicalDevice pdevice, VkDevice device, std::string texture, VkQueue& queue, VkCommandPool& pool, 
                        VkPhysicalDeviceMemoryProperties memProperties, VkImage& textureImage, VkDeviceMemory& textureImageMemory, uint32_t& mipLevels)
{
    ...
    stbi_image_free(pixels); // free pixel data after use
