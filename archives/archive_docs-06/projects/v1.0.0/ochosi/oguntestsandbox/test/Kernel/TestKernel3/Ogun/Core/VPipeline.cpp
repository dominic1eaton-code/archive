...
VGraphicsPipeline& VGraphicsPipeline::build()
{
    ...
    auto bindingDescription = VertexShaderData::bindingDescription();
    auto attributeDescriptions = VertexShaderData::attributeDescription();
    ...
    m_createInfo.pTessellationState = NULL;              // Optional
...
void VGraphicsPipeline::populateFixedFunctions()
{
    ...
    std::vector<VkPipelineColorBlendAttachmentState>* color_attachments = new std::vector<VkPipelineColorBlendAttachmentState>();
    color_attachments->push_back(m_colorBlendAttachment);
    color_attachments->push_back(colorBlendAttachment2);
    ...
    m_colorBlending.attachmentCount = color_attachments->size(); //1u;
    m_colorBlending.pAttachments =  color_attachments->data(); //&m_colorBlendAttachment;
