...
void VulkanModel::init(VulkanModelInfo info)
{
    ...
    scene->load(vertices, indices, meshes, dirlights);
...
void VulkanModel::draw(float tick)
{
    ...
    glm::mat4 view = glm::lookAt(glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0, 0.0, 1.0f));
...
void VulkanModel::recompileShaders()
{
    ...
    std::string shaderType = "ui";
    std::string shader = "default_ui";
    ...
    shaderFiles.push_back(std::filesystem::path(shaderLibraryPath) / shaderType / "default_ui.vert.spv");
    // shaderFiles.push_back(std::filesystem::path(shaderLibraryPath) / shaderType / "default_ui.geom.spv");
    shaderFiles.push_back(std::filesystem::path(shaderLibraryPath) / shaderType / "default_ui.frag.spv");
    // shaderFiles.push_back(std::filesystem::path(shaderLibraryPath) / shaderType / "default_ui.comp.spv");
