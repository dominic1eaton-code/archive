...
public:
    ...
    Square(glm::vec3 position)
        : Square(position, glm::vec3(1.0f), 0.5f, glm::vec4{1.0f, 0.0f, 0.0f, 1.0f})
    {}

    Square(glm::vec3 position, glm::vec3 scale)
        : Square(position, scale, 0.5f, glm::vec4{1.0f, 0.0f, 0.0f, 1.0f})
    {}

    Square(glm::vec3 position, glm::vec3 scale, float side, glm::vec4 color)
        : m_position(position)
        , m_scale(scale)
        , m_texture(1.0f, 1.0f)
        , m_size(1.0f, 1.0f, 1.0f)
        ...
        , m_side(side)
    {
        ...
        m_vertices = {
            ...
            {{( m_side*m_scale.x + m_position.x), ( m_side*m_scale.y + m_position.y), m_position.z*m_scale.z}, /*{1.0f, 0.0f, 0.0f, 1.0f}*/m_color, {0.0f, 0.0f}},
            {{(-m_side*m_scale.x + m_position.x), ( m_side*m_scale.y + m_position.y), m_position.z*m_scale.z}, /*{0.0f, 1.0f, 0.0f, 1.0f}*/m_color, {1.0f, 0.0f}},
            {{(-m_side*m_scale.x + m_position.x), (-m_side*m_scale.y + m_position.y), m_position.z*m_scale.z}, /*{0.0f, 0.0f, 1.0f, 1.0f}*/m_color, {1.0f, 1.0f}},
            {{( m_side*m_scale.x + m_position.x), (-m_side*m_scale.y + m_position.y), m_position.z*m_scale.z}, /*{1.0f, 1.0f, 1.0f, 1.0f}*/m_color, {0.0f, 1.0f}},
