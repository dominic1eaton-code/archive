...
macro(global_setup_unit_test)
    # find unit test tool
    set(GTEST_ROOT "C:/global/GTest/googletest/install/win32" CACHE PATH "GTest package path")
    # set(GTEST_ROOT "C:/global/GTest/1.15.2" CACHE PATH "GTest path")
    # if (WIN32)
    #     set(GTEST_ROOT "C:/global/GTest/googletest/install/win32" CACHE PATH "GTest package path")
    # elseif(UNIX)
    #     set(GTEST_ROOT "/mnt/c/global/GTest/googletest/install/unix" CACHE PATH "GTest package path")
    # endif()
    
    # set(ENV{GTEST_ROOT} "C:/global/GTest/googletest/install/win32")
...
macro(global_unit_test UNIT_TEST)
    ...
    if (WIN32)
        ...
        if(EXISTS ${CMAKE_CURRENT_BINARY_DIR}/Debug)
            file(COPY "${GTEST_ROOT}/bin/" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/Debug")
        endif()
    endif()
