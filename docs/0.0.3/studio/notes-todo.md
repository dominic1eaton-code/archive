...
| GR                    | Mungu                                |
| --------------------- | ------------------------------------ |
| Mass curves spacetime | Kernel mass curves entropy landscape |
| Geodesics             | Minimal entropy exposure paths       |
| Stress-energy tensor  | Kernel closure density               |
| Curvature             | Shadow-induced projection distortion |
...
1. Compresses information
2. Maintains invariant structure
3. Exists under entropy pressure
...
* recover Newton / Maxwell / Noether from this
* formalize+define+derive: Shadow-induced projection distortion, distortion, curvature, shadow induxed, Shadow-induced projection, Kernel closure density, closure density, density, Minimal entropy exposure paths, exposure, exposure paths, curves, kernel mass,  entropy landscape curvature, entropy landscape, spacetime, Geodesics, Stress-energy tensor
...
• formalize+define+derive: entropy, pressure, entropy pressure, shielding, entropy shielding, entropy shielding curvature, gradient, local gradient, global graddient, effective  effective entropy pressure, local gradient in effective entropy pressure
• derive Schwarzschild exactly
• derive Friedmann equations
• show Λ = background Ω slope
• unify GR + QM via kernel discretization
...
1. Static entropy field
2. Spherical symmetry
3. Vacuum outside kernel mass
...
formalize+define+derive: complexity, complexity pressure, netropy curvature, complexity curvature, interaction, interaction curvature, interaction between systems/objects/systems/grammars/particles/other-interactions
...
2. Curvatures
3. Pressures
4. Interaction (general)
5. Specializations (systems, grammars, particles, forces)
...
• derive **information gravity**
• collapse Φ/Ω into a **single kernel functional**
* formalize+define+derive: netropy, entropy curvature, netropy field, field, usable, usable structure
* compare+constrast+explain: netropy, entropy, complexity, kontinuity, projection, spectrum, cepstrum, frequency, quefrency, formants, cycles, periods, complex, vibration, stasis
...
• formalize+define+derive: netropy, entropy, complexity, kontinuity, projection, spectrum, cepstrum, frequency, quefrency, formants, cycles, periods, complex, vibration, stasis, reversible, irreversible, string, loop, kernel, seed
• formalize **QM as discrete kernel lattices**
• derive **uncertainty from projection loss**
...
1. **Canonical formal definitions (ontology + math)**
2. **QM as discrete kernel lattices**
3. **Uncertainty as projection loss (derived, not postulated)**
...
• formalize+define+derive: cost, shadow, composition, decomposition, constraint, multiplicity, rate, oscillation, recurrence, resonance, resonance structures, resonance flows, negentropy, self sustaining, bounds
• compare+constrast: netropy, negentropy, entropy, complexity
• derive **spin as kernel torsion**
• derive **measurement collapse as kernel reallocation**
...
claude, please organize + define + mathematically formalize + derive + explain + relate/connect + consolidate all of these notes:
...
* formalize+define+derive: virulent/insidious grammars, meta-analytics, meta-analytical frameworks, self-analyzing grammars, the self analysis bifurcation principle (performing analysis on one's self is what then allows an agentic self to cleave itself from its surroundings, forming its own distinct identity, while simultaneously creating a distinct identity for the external world surrounding/around the agent, where these two distinctions form a self stabilizing, closed feedback loop, that allow both systems to evolve one another, through the passing back of forth of data-information-knowledge-wisdom systems+grammars+memes, where it is the passing back and forth (transference) of these incubated memetic grammar systems between an agent and its environment, that generates flow-ic asymmetry and keeps both, and really all, systems alive, the "passing back and forth / transference" is the fundamental definition of "interaction", and is the minimal viable criteria to asset that any system exists and is "alive")
...
* Under Mungu Theory, MT, “mass” is structure/static and fundamentally termed and defined as “complexity”, and “energy” is flow/dynamic and fundamentally known as “entropy”. MT exists such that all known systems, from elementary particles, to social memes, to viral/bacterial diseases+pathogens, to blockchains+smartcontracts+DAOs, to simulations+games+video-games, to human+computer languages, pharmeceutical drugs, living organisms, planets+stars+celestial bodies+black holes, and everything else that can be imagined, including imagination itself, etc…. are all conjectured to share a fundamental, common, invariant set of isomorphisms that exist and can be used to describe any and all systems. Namely, all systems that exist, exist, and all systems that then exist must “survive” in order to continue to exist. What it then means to “survive” is that a system maintains its spatial (generalized as “polonic”) and temporal (generalized as “kolonic”) identity, continuously, where spatial identity invariance is known as “pontinuity” and temporal identity invariance is known as “kontinuity”, and iontinuity = {pontinuity+kontinuity} and then iontinuity invariance preservation is what then defines “survival”. This invariance preservation happens through the mechanism of “closure”, which requires decompression and compression of systems, in order to redistribute the primordial entropy-complexity space, in order for all systems to constantly maintain self integrity, in spite of always being in a constant state of flux/change. in order for decompression←>compression (together known as “distribution”) to “work”/operationalize, a minimal viable threshold of redistributable+transferability+preserverability must be met, through emergence of “patterns”. Only “incomplete patterns” can be transferred and only “complete patterns” can be preserved, so there then emerges a continuous “breaking/de-breaking”/”completing-in/de-completing” process of patterns, that drive closure, and allow for entropy-complexity to be redistributed, that inherently causes some systems to continue to survive as themselves, other systems to go extinct, and new systems to emerge. The polonic, static component of patterns are its “rules”, termed its “grammar” under MT, and these rules then “put into dynamic/kolonic/flow action” then become “memes”, that transfer, grow, develop, incubate, evolve, become extinct, are reborn, lifecycle, etc…. It is believed that everything that is discussed here is the minimal viable set of isomorphisms that all systems must, and do, abide by, and so these isomorphisms were, and are, then chosen to be the kernel systems that represent and define Mungu Theory. ~ @todo formalize+define+derive+perform: The Golden Experiments ~ set of experiments validating+verifying+testing the viability of the golden ratio hypotheses. The Mungu Experiments ~ set of experiments validating+verifying+testing the viability of MT, and everything that it describes
