...
CivOS ~ deployable, distributable/distributed, decentralized automata (automation) cells that collectively convert/transform inputs into outputs ~ sites/mechanisms of reactions
